...
def main():
    ...
    parser.add_argument("--faction", default="jahrekt", help="Faction/dynasty shown.")
    parser.add_argument("--unit-type", help="Unit or model type shown.")
    parser.add_argument("--color-scheme", help="Canonical material scheme reference (e.g., dynasty-standard), separate from energy color.")
