...
| Priority Alignment | In Development | `scripts/core/cross_domain_reasoning.py` detects `priority_mismatch` when active goals lack active linked execution. Sunday Planning and project review are wired to use it. | Add schedule-aware validation and richer execution-to-goal feedback. |
