...
- intent: capture | process-learning-notes | ask | summarize | review | revise | status | suggest-next-actions | schedule-change | plan-week | plan-day | diagnose-schedule | capture-friction | review-friction
...
- Questions asking what work to do next, today, at work, or within a stated time budget default to `suggest-next-actions`, not generic `ask`, `status`, or `plan-day`.
